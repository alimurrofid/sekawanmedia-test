        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 flex justify-between">
                    <h5 class="mb-0 dark:text-white">Table driver</h5>
                    <div class="flex">
                        <!-- Button Add driver -->
                        <a href="{{ route('driver.create') }}" type="button" data-tooltip-target="tooltip-adddriver"
                            ...
                            driver</a>
                        <div id="tooltip-adddriver" role="tooltip"
                            class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                            Tambahkan Kendaraan
                            <div class="tooltip-arrow" data-popper-arrow></div>
                        </div>
                        <!-- End Button Add driver -->
                    </div>
                </div>
                                ...
                                @foreach ($drivers as $driver)
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <div class="flex items-center justify-center">
                                                <!-- Button Edit driver -->
                                                <a href="{{ route('driver.edit', $driver->id) }}" type="button"
                                                    data-tooltip-target="tooltip-edit{{ $driver->id }}"
                                                ...
                                                <div id="tooltip-edit{{ $driver->id }}" role="tooltip"
                                                    class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                    Edit Kendaraan
                                                    <div class="tooltip-arrow" data-popper-arrow></div>
                                                </div>
                                                <!-- End Button Edit driver -->

                                                <!-- Button Delete driver -->
                                                <a href="{{ route('driver.destroy', $driver->id) }}"
                                                    data-tooltip-target="tooltip-delete{{ $driver->id }}"
                                                ...
                                                <div id="tooltip-delete{{ $driver->id }}" role="tooltip"
                                                    class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                                                    Hapus Kendaraan
                                                    <div class="tooltip-arrow" data-popper-arrow></div>
                                                </div>
                                                <!-- End Button Delete driver -->
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
