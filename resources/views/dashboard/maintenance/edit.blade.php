        ...
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 m-auto flex-0 lg:w-8/12">
                <div
                    ...
                    <div class="flex-auto">
                        <p class="p-6 text-sm leading-normal uppercase dark:text-white dark:opacity-60">Edit maintenance</p>
                        <form action="{{ route('maintenance.update', $maintenance->id) }}" class="p-4 md:p-5" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="flex flex-wrap -mx-3">
                                <!-- Dropdown untuk vehicle_id -->
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        ...
                                        <input type="date" name="date" id="date" required
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 @error('date') is-invalid @enderror"
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="description" id="description" required
                                            ...
                                            placeholder="e.g., Ganti Oli" value="{{ old('description', $maintenance->description) }}">
                                        @error('description')
                                            <div class="mt-2 text-sm text-red-500">
                                                {{ $message }}
                                            </div>
