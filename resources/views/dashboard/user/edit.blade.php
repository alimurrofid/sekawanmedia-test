        ...
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 m-auto flex-0 lg:w-8/12">
                <div
                    ...
                    <div class="flex-auto">
                        <p class="p-6 text-sm leading-normal uppercase dark:text-white dark:opacity-60">Edit user</p>
                        <form action="{{ route('user.update', $user->id) }}" class="p-4 md:p-5" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="name" required
                                            ...
                                            placeholder="eg. Toyota" value="{{ old('name', $user->name) }}">
                                        @error('name')
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="phone_number" required
                                            ...
                                            placeholder="eg. 081234567890" value="{{ old('phone_number', $user->phone_number) }}">
                                        @error('phone_number')
                                            <div class="mt-2 text-sm text-red-500">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        ...
                                        <input type="email" name="email" required
                                            ...
                                            placeholder="eg. name@example.com" value="{{ old('email', $user->email) }}">
                                        @error('email')
                                            <div class="mt-2 text-sm text-red-500">
                                                {{ $message }}
                                            </div>
