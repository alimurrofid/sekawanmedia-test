        ...
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 m-auto flex-0 lg:w-8/12">
                <div
                    ...
                    <div class="flex-auto">
                        <p class="p-6 text-sm leading-normal uppercase dark:text-white dark:opacity-60">Create vehicle</p>
                        <form action="{{ route('vehicle.store') }}" class="p-4 md:p-5" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="flex flex-wrap -mx-3">
                                <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="name" required
                                            ...
                                            placeholder="eg. Toyota" value="{{ old('name') }}">
                                        @error('name')
